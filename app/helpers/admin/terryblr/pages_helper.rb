module Admin::Terryblr::PagesHelper
  ...
  def page_field(page)
    content_tag(:span, (page.children.empty? ? '&nbsp;' : link_to_remote("", :url => admin_pages_path(:parent_id => page.id, :format => "js"), :method => :get)), :class => 'collapsed', :style => "margin-left:#{page.parents.size*17}px") +
