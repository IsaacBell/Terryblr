...
describe Terryblr::ContentPart do
  describe "validation" do
    ...
    it "should be invalid missing a body" do
      part = Terryblr::ContentPart.new(:content_type => "text")
    ...
    it "should be invalid missing a video" do
      part = Terryblr::ContentPart.new(:content_type => "videos")
      part.valid?.should eql(false)
      part.save.should eql(false)
    ...
    it "should be invalid missing photos" do
      part = Terryblr::ContentPart.new(:content_type => "photos")
      part.valid?.should eql(false)
      part.save.should eql(false)
    ...
    it "should not be valid with unknown state and post_type" do
      post = Terryblr::ContentPart.new(:content_type => "unknown")
    ...
    it "should be valid text content part" do
      part = Terryblr::ContentPart.new(:content_type => "text", :body => "this is some test text")
      part.valid?.should eql(true)
      part.save.should eql(true)
    end

    it "should be valid photos content part" do
      part = Terryblr::ContentPart.new(:content_type => "photos", :photos => [Factory(:photo)])
      part.valid?.should eql(true)
      part.save.should eql(true)
    end

    it "should be valid videos content part" do
      part = Terryblr::ContentPart.new(:content_type => "videos", :videos => [Factory(:video)])
      part.valid?.should eql(true)
      part.save.should eql(true)
    end
  ...
  describe "creation" do
    ...
    it "should create a content-part from photo attributes" do
      ...
      part = Terryblr::ContentPart.new(:content_type => "photos", :photo_ids => photos.map(&:id), :photos_attributes => photos.map(&:attributes))
      part.valid?.should eql(true)
      part.save.should eql(true)
    end
    ...
    it "should create a content-part from video attributes" do
      ...
      part = Terryblr::ContentPart.new(:content_type => "videos", :video_ids => videos.map(&:id), :videos_attributes => videos.map(&:attributes))
      part.valid?.should eql(true)
      part.save.should eql(true)
    end
