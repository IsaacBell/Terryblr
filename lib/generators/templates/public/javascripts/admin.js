...
$(document).ready(function() {
  ...
  if (rich_texts.length) {
    ...
    rich_texts.addClass('wymeditor').wymeditor({
  ...
  var state_input_css = '#post_published_at_input, #terryblr_page_published_at_input, #terryblr_product_published_at_input'
