...
$(document).ready(function() {
  ...
  var state_input_css = '#terryblr_post_published_at_input, #terryblr_page_published_at_input, #terryblr_product_published_at_input'
  ...
  var post_address = $("input#terryblr_post_address")
  var map_canvas = $("#map_canvas")
  if (typeof(google)!='undefined' && post_address.length && map_canvas.length && $.fn.autocomplete) {
  
    // Form elements
    var post_lat = $("input#terryblr_post_lat");
    var post_long = $("input#terryblr_post_long");
    var post_loc = $("input#terryblr_post_loc");
