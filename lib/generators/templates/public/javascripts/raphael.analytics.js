...
function drawTimeSeries(el) {
  ...
  var bgp = r.path().attr({stroke: "none", gradient: [90, color, color].join("-"), opacity: 0}).moveTo(leftgutter + X * 0.5, height - bottomgutter);
  var frame = r.rect(0, 0, 100, 40, 5).attr({fill: "#000", stroke: "#474747", "stroke-width": 2}).hide();
